        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['institusi'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['status'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['KepalaSuBagian'] == "" || $_REQUEST['nip'] == ""
                        ...
                        $KepalaSubBagian = $_REQUEST['KepalaSubBagian'];
                        $nip = $_REQUEST['nip'];
                        ...
                        if(!preg_match("/^[a-zA-Z0-9. -]*$/", $nama)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9. -]*$/", $institusi)){
                                $_SESSION['institusi'] = 'Form Nama hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan minus(-)';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {
                                ...
                                if(!preg_match("/^[a-zA-Z0-9.,:\/<> -\"]*$/", $status)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z., ]*$/", $KepalaSubBagian)){
                                            $_SESSION['kepsek'] = 'Form Nama KepalaSubBagian hanya boleh mengandung karakter huruf, spasi, titik(.) dan koma(,)<br/><br/>';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {

                                            if(!preg_match("/^[0-9 -]*$/", $nip)){
                                                $_SESSION['nipkepsek'] = 'Form NIP KepalaSubBagian hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                                echo '<script language="javascript">window.history.back();</script>';
                                            } else {
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',KepalaSubBagian='$KepalaSubBagian',nip='$nip',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',KepalaSubBagian='$KepalaSubBagian',nip='$nip',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="institusi" type="text" class="validate" name="institusi" value="<?php echo $row['institusi']; ?>" required>
                                            ...
                                            ?>
                                        <label for="institusi">Jenis</label>
                                    </div>
                                    <div class="input-field col s6">
